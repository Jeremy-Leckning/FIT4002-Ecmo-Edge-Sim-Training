...
Textbook Get Request Test 
    ${response}=    GET  http://localhost:5000/api/textbook 
    Status Should Be                 200

Textbook Get Request Test with parameters
    ${response}=    GET  http://localhost:5000/api/textbook/02
    Status Should Be                 200
