...
public:
    ...
    void advance_pump() {
        double flowAcceleration = totalGeneratedPressure() / 0.04;

        pumpFlow = flowVelocity + flowAcceleration * (1/refreshRate); // Integrator block
...
private:
    ...
    double rightAtriumBloodPressure[250];
    double aorticPressure[250];
    ...
    double totalGeneratedPressure() {
        ...
        return pumpPressure - pressureDrop;
    }
     ...
     */
    double cannulaPressureDrop(double cannulaLength, double frenchSizeLength)
    {
        double pi = 3.1415926;
    ...
    {
        double cannulaInPressureDrop = cannulaPressureDrop(cannulaInLength, frenchSizeInLength);
        
        if (bloodVesselSuction) {
            cannulaInPressureDrop += bloodVesselSuctionPressureDrop();
        }

        double cannulaOutPressureDrop = cannulaPressureDrop(cannulaOutLength, frenchSizeOutLength);
